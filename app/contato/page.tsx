        ...
        <div className="mt-16 flex justify-between gap-12">
          ...
          <div className="flex w-3/5 flex-col items-center">
            <img
              ...
              src="https://lp.ciadearquitetura.com/wp-content/uploads/2023/07/3.webp"
              alt=""
            />
            <div className="-mt-24 grid grid-cols-3 overflow-hidden rounded-full border border-stone-200 bg-white px-6">
              <div className="p-6">
                <div className="text-sm font-medium uppercase tracking-wider">
                  Email
                </div>
                <div className="mt-4 font-light text-stone-600">
